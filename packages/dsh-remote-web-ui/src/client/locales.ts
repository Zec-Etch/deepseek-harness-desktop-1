...
export const zh = {
  ...
  'status.lanRequired': '当前没有可达的手机地址，请开启 autoTunnel 或配置公网地址',
  'status.lanRequiredHint': '当前服务仅绑定在 127.0.0.1 且未配置公网地址，手机无法访问。请在设置中开启自动公网隧道或填写内网穿透地址；只有官方明确放行 all-interface bind 的 DSH build 才能使用 --host 0.0.0.0。',
...
export const en = {
  ...
  'status.lanRequired': 'No reachable phone address is configured; enable autoTunnel or set a public address',
  'status.lanRequiredHint': 'The server is bound to 127.0.0.1 and no public address is configured, so a phone cannot reach it. Enable the auto public tunnel or set a tunneled public address in settings; use --host 0.0.0.0 only on a DSH build whose official runtime explicitly permits all-interface binding.',
