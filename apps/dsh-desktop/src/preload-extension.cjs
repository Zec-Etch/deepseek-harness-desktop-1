...
const api = Object.freeze({
  ...
  installPlugin: (spec, allowUnknown = false, fullAccess = false, allowIncompatible = false) => ipcRenderer.invoke('extensions:plugin-install', { spec, allowUnknown, fullAccess, allowIncompatible }),
  installPluginBatch: (specs, allowUnknown = false) => ipcRenderer.invoke('extensions:plugin-install-batch', { specs, allowUnknown }),
  updatePlugin: (name, allowUnknown = false, allowIncompatible = false) => ipcRenderer.invoke('extensions:plugin-update', { name, allowUnknown, allowIncompatible }),
  ...
  getLegacyPluginRestoreState: () => ipcRenderer.invoke('extensions:legacy-plugin-restore-state'),
  restoreLegacyGitPlugin: (id) => ipcRenderer.invoke('extensions:legacy-plugin-restore-git', id),
  ...
  installMarketPlugin: (id, allowIncompatible = false) => ipcRenderer.invoke('extensions:market-install', { id, allowIncompatible }),
