...
| profile-home | apps/dsh-desktop/scripts/verify-packaged-agent-work.mjs | 269 | DSH_HOME |
| profile-home | apps/dsh-desktop/scripts/verify-packaged-agent-work.mjs | 330 | DSH_HOME |
